    ...
    private fun setButtonText() {
        ...
        result.forEach {
            ...
            when (it.strId) {
                ...
                getString(button1_2.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button1_3.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button1_4.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button1_5.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button1_6.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button1_7.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_1.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_2.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_3.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_4.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_5.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_6.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button2_7.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_1.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_2.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_3.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_4.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_5.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_6.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button3_7.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_1.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_2.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_3.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_4.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_5.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_6.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button4_7.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_1.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_2.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_3.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_4.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_5.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_6.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
                getString(button5_7.id) -> button1_1.text = it.strSubject + "\n" + it.strClassRoom
